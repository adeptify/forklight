...
- Produce and review a dry-run classification of historical Tasks, then apply the approved cleanup:
  ...
  - preserve two verified backups and require separate approval before deleting either backup;
...
Exit: passed. Exact baseline, two verified backups, applied retention report, Candidate decision
and selected M1 work are recorded in [progress.md](./progress.md) and [evidence/](./evidence/).
